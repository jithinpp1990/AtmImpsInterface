...
namespace AtmImpsServer
{
    class DBClass
    {
        ...
        public int GetMaxId(string as_tablename, int ai_ids_reqd)
        {
            int max_id = 0;
            try
            {
        ...
        public ATM_IMPS_VAS_ResponseModel AcquirerCashWithdrawal(ATM_IMPS_VAS_RequestModel model)
        {
            ...
            try
            {
                sql_string = "select sf_process_atm_acquirer_withdrawals('" + model.ProcesingCode + "','" + model.AtmCardNumber + "','" + model.PAN + "','" + model.Date + "','" + model.Amount + "','" + model.AccountType + "','" + model.TrackerID + "','" + model.AtmDetails + "') response_code";
                WithdrawalResponse.ResponseCode = mFields_obj.ResponseCode(Convert.ToString(db_select_operation(sql_string, "response_code")));
            }
            catch (Exception ex)
            {
        ...
        public ATM_IMPS_VAS_ResponseModel AcquirerCashWithdrwalReverse(ATM_IMPS_VAS_RequestModel model)
        {
            ...
            try
            {
                sql_string = "select sf_process_atm_acquirer_withdrawals_reversal('" + model.ProcesingCode + "','" + model.AtmCardNumber + "','" + model.PAN + "','" + model.Date + "','" + model.STAN + "','" + model.Amount + "' ,'" + model.OriginalData + "','" + model.TrackerID + "','" + model.AtmDetails + "') response_code";
                ReversalResponse.ResponseCode = mFields_obj.ResponseCode(Convert.ToString(db_select_operation(sql_string, "response_code")));
            }
            catch (Exception)
            {
